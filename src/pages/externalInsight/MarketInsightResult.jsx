  ...
  return (
    <div className="bg-grey-bg min-h-screen w-screen overflow-hidden main">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 p-2 my-1 gap-1 h-full overflow-hidden">
        ...
        <div className="sm:col-span-3 py-4 px-4 sm:px-12 bg-white border border-gray-200 rounded-lg shadow dark:border-gray-100">
          <div className="relative">
            <div className="card py-4 px-8 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-300 marketResultDiv">
              <div className="flex items-center gap-2 my-2">
                <img src={BrightImg} alt={BrightImg} />
                <p className="mb-5 text-sm font-bold tracking-tight dark:text-gray-700 flex mt-2">
                  What is the market share of the major players in the fintech
              ...
              <div className="flex justify-between ref">
                <div className="flex items-center gap-2">
                  <p className="text-[14px]">Reference:</p>
                  <Paginate />
                </div>
