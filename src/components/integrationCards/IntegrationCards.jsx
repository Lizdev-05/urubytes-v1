...
import qbImg from "../../assets/qb2.png";
import googleImg from "../../assets/goggle.png";
import airTable from "../../assets/airtable2.png";
    ...
    <div className="flex justify-start gap-8 items-center my-2">
      <div className="w-220 h-220 rounded-lg border border-gray-200 py-1 px-6">
        <div className="flex justify-center">
          <img src={driveImage} alt="Drive" className=" h-24 p-4" />
        </div>
        <div className="flex justify-center">
      ...
      <div className="w-220 h-220 rounded-lg border border-gray-200 py-1 px-6">
        <div className="flex justify-center">
          <img src={googleSheets} alt="Google Sheets" className=" h-24 p-4" />
        </div>
        <div className="flex justify-center">
      ...
      <div className="w-220 h-220 rounded-lg border border-gray-200 py-1 px-6">
        <div className="flex justify-center">
          <img src={googleDocs} alt="Google Docs" className="h-24 p-4" />
        </div>
        <div className="flex justify-center">
      ...
      <div className="w-220 h-220 rounded-lg border border-gray-200 py-1 px-6">
        <div className="flex justify-center">
        <img src={qbImg} alt="QuickBooks" className="h-24 p-4"/>
        </div>
        <div className="flex justify-center">
      ...
      <div className="w-220 h-220 rounded-lg border border-gray-200 py-1 px-6">
        <div className="flex justify-center">
          <img src={airTable} alt="Airtable" className=" h-24 p-4" />
        </div>
        <div className="flex justify-center">
